...
DAEMON_ARGS="/var/www/raspi-kiosk-server/nodejs/server.js"               # path to your node.js server/app
...
LOCAL_VAR_RUN=/var/www/run            # in case the init script is run by non-root user, you need to
